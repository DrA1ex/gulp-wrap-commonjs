...
(function() {
  ...
  module.exports = function(options) {
    ...
    var escapedDirname = __dirname.replace(/\\/g, "/");
    _.defaults(options, defaultOptions);
    templateJs = _.template(fs.readFileSync(escapedDirname + "/templates/js.tpl", {
      encoding: 'utf8'
    }));
    templateCoffee = _.template(fs.readFileSync(escapedDirname + "/templates/coffee.tpl", {
      encoding: 'utf8'
    }));
